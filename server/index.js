...
const allowedOrigins = ['http://localhost:5173','http://localhost:5174','movie-booking-app-admin-irzqwx0hs-nasrudeen-s-projects.vercel.app']; // Add more origins as needed
app.use(
    cors({
